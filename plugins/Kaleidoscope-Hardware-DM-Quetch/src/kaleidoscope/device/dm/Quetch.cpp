...
using KeyScannerProps = typename kaleidoscope::device::olkb::QuetchProps::KeyScannerProps;
using KeyScanner = typename kaleidoscope::device::olkb::QuetchProps::KeyScanner;
